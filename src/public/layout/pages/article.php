    ...
    <div class="container">
        <div class="breadcrumbs">
            <ul itemscope="" itemtype="http://schema.org/BreadcrumbList" class="breadcrumbs__ul">
                ...
                <li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem" class="breadcrumbs__li">
                    <a itemprop="item" title="Статьи" href="#" class="breadcrumbs__a">
                        <span itemprop="name" class="breadcrumbs__name">Статьи</span>
                        <meta itemprop="position" content="1">
                    </a>
                </li>
                <li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem" class="breadcrumbs__li">
                    <span itemprop="name" class="breadcrumbs__name">Наименование статьи</span>
                    <meta itemprop="position" content="2">
                </li>
            </ul>
        </div>
        <div class="title">
            <h1>Наименование статьи <span>от 14.06.2024</span></h1>
        </div>
        <div class="description">
            <div class="description-image">
                <span>
                    <img src="assets/image/demo/articlepage.webp" alt="">
                </span>
            </div>
