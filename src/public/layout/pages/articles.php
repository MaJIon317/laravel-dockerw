    ...
    <div class="container">
        <div class="breadcrumbs">
            <ul itemscope="" itemtype="http://schema.org/BreadcrumbList" class="breadcrumbs__ul">
                ...
                <li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem" class="breadcrumbs__li">
                    <span itemprop="name" class="breadcrumbs__name">О чем мы пишем</span>
            ...
            <div class="newspage-item">
                <div class="sectionpromotion__item-block">
                    <div class="sectionpromotion__item-image">
                        <a href="#" class="sectionpromotion__item-a">
                            <img src="assets/image/demo/sectionpromotion.webp" alt="" class="sectionpromotion__item-img">
                        </a>
                    </div>
                    <div class="sectionpromotion__item-date">21 февраля 2024</div>
                    <h5 class="sectionpromotion__item-name">
                        <a href="#">Наименование статьи</a>
                    </h5>
                    <p class="sectionpromotion__item-description">Краткое описание статьи до 150 символов</p>
                </div>
            </div>
