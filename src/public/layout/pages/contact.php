    ...
    <div class="container">
        <div class="breadcrumbs">
            <ul itemscope="" itemtype="http://schema.org/BreadcrumbList" class="breadcrumbs__ul">
                ...
                <li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem" class="breadcrumbs__li">
                    <span itemprop="name" class="breadcrumbs__name">Контакты</span>
    ...
    <div class="container">
        <div class="contactpage">
            <div class="contactpage__contact">
                <div class="contactpage__contact-address">Санкт-Петербург, пр. Обуховской Обороны, д. 86а, 3 этаж</div>
                <div class="contactpage__contact-data">
                    <div class="contactpage__contact-title">Режим работы</div>
                    <div class="contactpage__contact-desc">Пн. – Пт.: с 10.00 до 18:00</div>
                </div>
                <div class="contactpage__contact-data">
                    <div class="contactpage__contact-title">Телефон</div>
                    <div class="contactpage__contact-desc">
                        <a href="tel:+88126767633">8 812 676-76-33</a>
                    </div>
                    <div class="contactpage__contact-desc">
                        <a href="tel:+88126767633">8 800 200-86-33</a><span> - бесплатно по России</span>
                    </div>
                </div>
                <div class="contactpage__contact-data">
                    <div class="contactpage__contact-title">E-mail</div>
                    <div class="contactpage__contact-desc">
                        <a href="mailto:+sales@million-otkrytok.ru">sales@million-otkrytok.ru</a>
                    </div>
                </div>
            </div>
            <div class="contactpage__map">
                <div id="contactpagemap" class="contactpage__map-map"></div>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="faq__items">
                <div class="faq__item">
                    <div class="faq__block">
                        <h4 class="faq__title">
                            <span>Есть ли у Вас скидки?</span>
                        ...
                        <div class="faq__desc">Да, у нас есть скидки и спецпредложения. Ознакомиться со всеми предложениями можно в разделе <a href="#">«Скидки»</a>. </div>
                    </div>
                </div>
                <div class="faq__item">
                    <div class="faq__block">
