...
<section class="section section--categorypage">
    <div class="container">
        <div class="categorypage__banner">
            <img src="assets/image/demo/category-banner.webp" alt="" class="categorypage__banner-img">
        </div>
        <div class="categorypage__category">
            ...
            <div class="categorypage__category-items">
                <a href="#" class="categorypage__category-item">Подкатегория 1</a>
                <a href="#" class="categorypage__category-item">Подкатегория 2</a>
                <a href="#" class="categorypage__category-item">Подкатегория 3</a>
                <a href="#" class="categorypage__category-item">Подкатегория 4</a>
                <a href="#" class="categorypage__category-item">Подкатегория 5</a>
                <a href="#" class="categorypage__category-item">Подкатегория 6</a>
                <a href="#" class="categorypage__category-item">Подкатегория 7</a>
                <a href="#" class="categorypage__category-item">Подкатегория 8</a>
            </div>
        </div>
        <div class="sorts">
            <div class="sort">
