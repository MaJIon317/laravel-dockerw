                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $count => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($count <= 8): ?>
                                    <li class="menucatalog__general-li">
                                        ...
                                        <button class="menucatalog__general-a" data-menu-open="menucatalog" title="<?php echo e($category->title); ?>" wire:click.prevent="$dispatch('menu', 'menucatalog')">
                                        <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                            ...
                                            <?php endif; ?>
                                        </<?php echo e($category->children->count() ? 'button' : 'a'); ?>>
                                    </li>
                                <?php endif; ?>
                ...
                <div class="sectionhome__data-items">
                    <div class="sectionhome__data-item">
                        <div class="sectionhome__data-slider">
                            <?php if(config('settings.section_home.slider')): ?>
                                <div class="swiper-section">
                                    <div class="swiper" data-slider-design="home">
                                        <div class="swiper-wrapper">
                                            <?php $__currentLoopData = config('settings.section_home.slider'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if(isset($item['status']) && !empty($item['status'])): ?>
                                                    <div class="swiper-slide">
                                                        <?php if(empty($item['link'])): ?>
                                                            <div class="sectionhome__data-item_a">
                                                                <img src="<?php echo e(resize($item['image'], 1075, 400)); ?>" alt="<?php echo e($item['title']); ?>">
                                                            </div>
                                                        <?php else: ?>
                                                            <a href="<?php echo e($item['link']); ?>" class="sectionhome__data-item_a" wire:navigate>
                                                                <img src="<?php echo e(resize($item['image'], 1075, 400)); ?>" alt="<?php echo e($item['title']); ?>">
                                                            </a>
                                                        <?php endif; ?>
                                                    </div>
                        ...
                        <div class="sectionhome__data-item">
                            <?php if(empty($banner['link'])): ?>
                                <div class="sectionhome__data-banner">
                                    <img src="<?php echo e(resize($banner['image'], 300, 400)); ?>" alt="<?php echo e($banner['title']); ?>">
                                </div>
                            <?php else: ?>
                                <a href="<?php echo e($banner['link']); ?>" class="sectionhome__data-banner" wire:navigate>
                                    <img src="<?php echo e(resize($banner['image'], 300, 400)); ?>" alt="<?php echo e($banner['title']); ?>">
                                </a>
                            <?php endif; ?>
                        </div>
                ...
                <div class="sectionhome__data-items">
                    ...
                    <div class="sectionhome__data-item">
                        <?php if($banner): ?>
                            <?php if(empty($banner['link'])): ?>
                                <div class="sectionhome__data-banner">
                                    <img src="<?php echo e(resize($banner['image'], 527, 180)); ?>" alt="<?php echo e($banner['title']); ?>">
                                </div>
                            <?php else: ?>
                                <a href="<?php echo e($banner['link']); ?>" class="sectionhome__data-banner" wire:navigate>
                                    <img src="<?php echo e(resize($banner['image'], 527, 180)); ?>" alt="<?php echo e($banner['title']); ?>">
                    ...
                    <div class="sectionhome__data-item">
                        <?php if($banner): ?>
                            <?php if(empty($banner['link'])): ?>
                                <div class="sectionhome__data-banner">
                                    <img src="<?php echo e(resize($banner['image'], 300, 180)); ?>" alt="<?php echo e($banner['title']); ?>">
                                </div>
                            <?php else: ?>
                                <a href="<?php echo e($banner['link']); ?>" class="sectionhome__data-banner" wire:navigate>
                                    <img src="<?php echo e(resize($banner['image'], 300, 180)); ?>" alt="<?php echo e($banner['title']); ?>">
...
</section><?php /**PATH /var/www/resources/views/components/section/home.blade.php ENDPATH**/ ?>