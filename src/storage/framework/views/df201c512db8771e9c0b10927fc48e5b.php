...
$message = $__bag->first($__errorArgs[0]); ?>
            <div class="sectionnews__form-form_error"><?php echo e($message); ?></div>
        <?php unset($message);
...
unset($__errorArgs, $__bag); ?> 
        ...
        <div class="sectionnews__form-form_aggre">
            Отправляю E-mail, вы соглашаетесь с <a href="<?php echo e(route('information', 'policy')); ?>" wire:navigate>пользовательским соглашением</a> и <a href="<?php echo e(route('information', 'terms')); ?>" wire:navigate>политикой конфиденциальности</a>
        </div>
    </form>
</div><?php /**PATH /var/www/resources/views/components/section/subscription/news.blade.php ENDPATH**/ ?>