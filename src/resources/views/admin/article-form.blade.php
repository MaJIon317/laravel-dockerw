    ...
    <div class="tab-content" id="defaultTabContent">
        <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
            ...
            <div class="row">
                <div class="col-auto">
                    <x-input.admin.image 
                        name="image" 
                        :value="old('image') ?? $article->image ?? null" 
                        path="articles"
                        label="Изображение" 
                ...
                <div class="col-auto">
                    <x-input.admin.image 
                        name="banner" 
                        :value="old('banner') ?? $article->banner ?? null" 
                        path="articles"
                        label="Баннер" 
            ...
            <x-input.admin.text 
                type="datetime-local"
                name="publish_date" 
                :value="old('publish_date') ?? $article->publish_date ?? null" 
                label="Опубликовать" 
            ...
            <x-input.admin.checkbox 
                ...
                :checked="(old('status') || ($article->status ?? null))"
                />
        ...
        <div class="tab-pane fade" id="meta" role="tabpanel" aria-labelledby="meta-tab">
            ...
            <x-input.admin.text 
                type="text" 
                name="meta_title" 
                :value="old('meta_title') ?? $article->meta_title ?? null" 
                label="Заголовок" 
            ...
            <x-input.admin.textarea 
                type="text" 
                name="meta_keywords" 
                :value="old('meta_keywords') ?? $article->meta_keywords ?? null" 
