...
namespace App\Integration\Exchange1C;
...
class Config
{
    ...
    private array $models = [
        \App\Integration\Exchange1C\Interfaces\GroupInterface::class => null,
        \App\Integration\Exchange1C\Interfaces\ProductInterface::class => null,
        \App\Integration\Exchange1C\Interfaces\OfferInterface::class => null,
        \App\Integration\Exchange1C\Interfaces\PriceTypeInterface::class => null,
    ];

    private array $services = [
        \App\Integration\Exchange1C\Services\AuthService::class => null,
    ];
