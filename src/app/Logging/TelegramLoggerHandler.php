...
class TelegramLoggerHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(string $logLevel)
    {
        ...
        $this->telegramService = new TelegramService(config('settings.log_to_telegram.token'), config('settings.log_to_telegram.chat', []));
    }
    ...
    {
        $this->telegramService->sendMessage($this->formatLogText($record), strtolower($record['level_name']));
    }
